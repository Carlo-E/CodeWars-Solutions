...
function formatTimeString(totalCount) {
  ...
  if (
    totalCount.days === "0 days" &&
    totalCount.hours === "0 hours" &&
    totalCount.seconds === "0 seconds"
  ) {
  ...
  if (totalCount.days === "0 days" && totalCount.minutes === "0 minutes") {
    return `${totalCount.hours}, ${totalCount.seconds}`;
  }
  ...
  if (totalCount.hours === "0 hours" && totalCount.seconds === "0 seconds") {
    return `${totalCount.days}, ${totalCount.minutes}`;
  }

  if (totalCount.days === "0 days" && totalCount.seconds === "0 seconds") {
    return `${totalCount.hours}, ${totalCount.minutes}`;
  }
  ...
  if (totalCount.seconds === "0 seconds") {
    return `${totalCount.days}, ${totalCount.hours}, ${totalCount.minutes}`;
  }
  if (totalCount.hours === "0 hours") {
    return `${totalCount.days}, ${totalCount.minutes}, ${totalCount.seconds}`;
  }
  if (totalCount.minutes === "0 minutes") {
    return `${totalCount.days}, ${totalCount.hours}, ${totalCount.seconds}`;
  }
